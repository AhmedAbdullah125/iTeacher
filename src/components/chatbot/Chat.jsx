        ...
        <div className="chat-main">
            <div className="yell-cont">
                <div className="sos-cont">
                    <Image src={sos} alt="iTeacher" />
                </div>
                <div className="cls-cont">
                    <Image src={cls} alt="iTeacher" />
                </div>
                <div className="white-cont">
                    <div className="messages-cont">
                        {
                            messages.map((message) =>
                                message.owner == 'me' ?
                                    ...
                                    :
                                    <div className="chatpor-message-cont ">
                                        <Image src={mLogo} alt="iTeacher" />
                                        <p className="message">{parse(message.message)}</p>
                                    </div>
                            )
                        }
                    ...
                    <div className="btns-cont">
                        ...
                        <div className="send-btn-cont">
                            ...
                            <Image src={hager} alt="iTeacher" className='hagar' />
                        </div>
                    </div>
                </div>
            </div>
